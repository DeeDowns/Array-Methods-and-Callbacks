...
//              return `${data["Home Team Name"]}, ${data["Away Team Name"]}, ${data["Home Team Goals"]}, ${data["Away Team Goals"]}, `;
//         };  
//     })
// }
...
const finals = (data) => data.filter(function(item){
    if(item.Stage === "Final"){
        return item.Stage
    };
})
console.log(finals(fifaData));
